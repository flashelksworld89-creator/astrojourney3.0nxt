# AstroWalk Journey 3.6.4 — Route Navigation + Street Lock

This build keeps the 3.5.2 map/compass/HUD baseline and adds:

## 3.6.4 navigation additions
...
## 3.6.4 deployment repair
- Rebased on the stable 3.6.4 project.
- Keeps the 3.6.4 context-synthesis interpretation engine.
