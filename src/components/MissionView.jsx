...
export default function MissionView({mission,gps,gpsError,onBack}){
  ...
  const changeTrackingMode=mode=>{
    ...
    if(mode==='static'){
      ...
      setLastAnalysisAt(Date.now());
      setMovedMeters(0);
      // Tracking mode no longer forces the wheel scale. The 4.4-mile nakshatra
      // reach remains available while walking/driving presets can be chosen manually.
    }
  };
